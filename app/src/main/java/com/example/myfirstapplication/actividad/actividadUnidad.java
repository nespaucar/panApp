...
public class actividadUnidad extends Fragment {
    ...
    public actividadUnidad() {
        // Required empty public constructor
    }

    public static actividadUnidad newInstance(String param1, String param2) {
        actividadUnidad fragment = new actividadUnidad();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        codigo = (EditText) view.findViewById(R.id.unidad_codigo);
        nombre = (EditText) view.findViewById(R.id.unidad_nombre);
        id = (EditText) view.findViewById(R.id.unidad_id);
        btn = (Button) view.findViewById(R.id.btn_registrar_unidad);
            ...
            public void onClick(View v) {
                ...
                if(!codigo.getText().toString().equals("") && !codigo.getText().toString().equals("")) {
                    if(id.getText().toString().equals("0")) {
                        conexion.insertarRegistro(objeto, Utilidades.TABLA_UNIDAD);
                        stringRequest =  conexion.insertarRegistroWebService(getContext(), Utilidades.WS_INSERTAR, Utilidades.TABLA_UNIDAD, objeto);
                        limpiarFormulario();
                        mensaje = "INSERTADO";
                    } else {
                        conexion.actualizarRegistro(objeto, Utilidades.TABLA_UNIDAD);
                        stringRequest =  conexion.actualizarRegistroWebService(getContext(), Utilidades.WS_ACTUALIZAR, Utilidades.TABLA_UNIDAD, objeto);
                        mensaje = "ACTUALIZADO";
                    }

                    requestQueue = Volley.newRequestQueue(getContext());
                    requestQueue.add(stringRequest);
                    mensaje = "UNIDAD " + mensaje + " CORRECTAMENTE";
                } else {
