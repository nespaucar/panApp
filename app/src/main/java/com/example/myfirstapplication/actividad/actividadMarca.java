...
public class actividadMarca extends Fragment {
    ...
    public actividadMarca() {
        // Required empty public constructor
    }

    public static actividadMarca newInstance(String param1, String param2) {
        actividadMarca fragment = new actividadMarca();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        codigo = (EditText) view.findViewById(R.id.marca_codigo);
        nombre = (EditText) view.findViewById(R.id.marca_nombre);
        id = (EditText) view.findViewById(R.id.marca_id);

        btn = (Button) view.findViewById(R.id.btn_registrar_marca);
            ...
            public void onClick(View v) {
                ...
                if(!codigo.getText().toString().equals("") && !codigo.getText().toString().equals("")) {
                    ...
                    if(id.getText().toString().equals("0")) {
                        conexion.insertarRegistro(objeto, Utilidades.TABLA_MARCA);
                        stringRequest =  conexion.insertarRegistroWebService(getContext(), Utilidades.WS_INSERTAR, Utilidades.TABLA_MARCA, objeto);
                        limpiarFormulario();
                        mensaje = "INSERTADO";
                    } else {
                        conexion.actualizarRegistro(objeto, Utilidades.TABLA_MARCA);
                        stringRequest =  conexion.actualizarRegistroWebService(getContext(), Utilidades.WS_ACTUALIZAR, Utilidades.TABLA_MARCA, objeto);
                        mensaje = "ACTUALIZADO";
                    }

                    requestQueue = Volley.newRequestQueue(getContext());
                    requestQueue.add(stringRequest);
                    mensaje = "MARCA " + mensaje + " CORRECTAMENTE";
                } else {
